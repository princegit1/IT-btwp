...
<cache:cache key="<%=SITE_URL+"index_post.jsp"%>" scope="application" time="300" refresh="t">
...
<!-- <h2 style="text-align:center; color:#777777;">UNION BUDGET 2014-15</h2>
 ...
 <img src="http://media2.intoday.in/businesstoday/mobile/banner.gif">
 </div> 

<div class="heading"><a href="<%=SITE_BASEPATH+"category/636/1/decoding-budget-2014.html "%>" class="subheadings"><h2>BUDGET DECODED</h2></a></div>
	  <%
    ArrayList contentAL22 = null;
    contentAL22 = (ArrayList)CommonFunctions.latestStories("178#636", 1, "0");
        ...
        for (int ctr = 0; ctr < contentAL22.size(); ctr++) {
            ...
            if (ctr == 0) {%>
              ...
              <div style="clear:both"></div>
               <div class="more" style="PADDING-LEFT: 2px; margin-top: 7px; BORDER-BOTTOM: #c7c7c7 1px solid;BORDER-TOP: #c7c7c7 1px solid;height:20px;padding-top:2px;"><a href="<%=SITE_BASEPATH+CommonFunctions.storyURL(cDTO.getSefTitle(),1, cDTO.getId())%>">more &raquo;</a></div>
              </div>
  
  <%}}}%>
 

 <div class="heading"><a href="<%=SITE_BASEPATH+"budget/index.jsp"%>" class="subheadings"><h2 style="text-transform:uppercase">Highlights</h2></a></div>
    <jsp:include page="budget/highlights_chunk_mainheader.jsp" flush="true" >
	<jsp:param name="id" value="207984" /> 	
	</jsp:include>
...
<div class="tab">
   ...
   <div class="home-slider-tab">
    <div class="belt-outer">
      ...
      <ul class="belt-tab">
           	<li><div class="box-tab"><a href="#taxation" class="active-tab">ANNOUNCEMENTS  Announcements</a></div></li>
          	<li><div class="box-tab"><a href="#price-hike">YOUR FINANCES</a></div></li>
         	<li><div class="box-tab"><a href="#ceowishlist">REACTIONS</a></div></li>
            <li><div class="box-tab"><a href="#corporate">CORPORATE SPEAK</a></div></li>
      </ul>
   ...
   <div class="tab-budget" id="price-hike" style="display:none;">   
    	<jsp:include page="latest_stories_chunk_budget.jsp" flush="true" >
		<jsp:param name="categoryId" value="178#637" /> 
		<jsp:param name="contentCount" value="3" /> 
		<jsp:param name="storyIdToAvoid" value="0" /> 
		</jsp:include>   
   </div>
	<div class="tab-budget" id="ceowishlist" style="display:none;">   
        <jsp:include page="latest_stories_chunk_budget.jsp" flush="true" >
        <jsp:param name="categoryId" value="178#639" /> 
        <jsp:param name="contentCount" value="3" /> 
        <jsp:param name="storyIdToAvoid" value="0" /> 
        </jsp:include>   
   </div>
   <div class="tab-budget" id="corporate" style="display:none;">   
        <jsp:include page="latest_stories_chunk_budget.jsp" flush="true" >
 ...
 <div class="heading"><a href="<%=SITE_BASEPATH+"section/180/1/railway-budget-2014-15.html"%>" class="subheadings"><h2 style="text-transform:uppercase">Railway Budget</h2></a></div>
  ...
  <%
    ArrayList contentAL21 = null;
    contentAL21 = (ArrayList)CommonFunctions.latestStories("180", 1, "0");
    if (contentAL21 != null && contentAL21.size() > 0) {
        for (int ctr = 0; ctr < contentAL21.size(); ctr++) {
            ContentListDTO cDTO = (ContentListDTO) contentAL21.get(ctr);
            if (ctr == 0) {%>
              <div class="container cf">
              <span class="georgia lead"> <a href="<%=SITE_BASEPATH+CommonFunctions.storyURL(cDTO.getSefTitle(),1, cDTO.getId())%>" style="font-size:18px;"><%=cDTO.getTitle()%></a></span><br/><br/>
               <a href="<%=SITE_BASEPATH+CommonFunctions.storyURL(cDTO.getSefTitle(),1, cDTO.getId())%>"><img src="<%=STORY_IMAGE_BASEPATH+cDTO.getImage().trim()%>" border="0" style="float:left; margin-right:10px;"></a>
              <span style=" color:#555454; font-size: 15px;    line-height: 17px;"><%=cDTO.getFullDescription()%></span>
               <div class="more" style="PADDING-LEFT: 2px; BORDER-BOTTOM: #c7c7c7 1px solid;BORDER-TOP: #c7c7c7 1px solid;height:20px;padding-top:2px;"><a href="<%=SITE_BASEPATH+CommonFunctions.storyURL(cDTO.getSefTitle(),1, cDTO.getId())%>">more &raquo;</a></div>
              </div>
...
<jsp:include page="budget/latest_stories_chunk.jsp" flush="true" >
...
<%@include file="budget/home_video_chunk.jsp"%>
<div style="height:8px;"></div>
