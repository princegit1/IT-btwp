...
%>
<cache:cache key="http://m.businesstoday.in/btwap/budget/2015_back/latest_stories_chunk_budget.jsp?categoryId=<%=categoryId %>&contentCount=<%=contentCount %>" scope="application" time="600" > 
...
%>
   <div class="heading"><a class="subheadings" href="#"><h2>EXPERT SPEAK</h2><span class="moretxt">MORE</span></a></div>
		...
		if (ctr == 0) {
			if(pcatlength==1)
		     ...
		     %>
              ...
              <div class="heading"><a class="subheadings" href="<%=SITE_BASEPATH+CommonFunctions.categoryURL(cDTO.getCurrentCategorySefTitle(),1,cDTO.getCurrentCategoryId())%>"><h2>EXPERT SPEAK</h2><span class="moretxt">MORE</span></a></div>
