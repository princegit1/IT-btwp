...
.budget-header { background:#2e3094; font-size:28px; line-height:24px; padding:10px; color:#fff; font-family:roboto; margin-bottom:15px; position:relative; margin-top:5px;}
...
span.moretxt{  font-size: 13px; font-weight: bolder; position: absolute; right: 10px; top: 3px; width: auto;}
...
out.println(dateNow+" IST"); %>
  ...
  <div class="searchbox-inner"><input type="text" style="float:left"><input type="submit" style="float:left;background:#d80017; color:white; border:none;margin: 2px;    padding: 1px;" value="SEARCH"></div>
  </div>
...
<div id="budget-conetent">
  ...
  <div class="whitebox">
    ...
    topStoryList = (ArrayList)CommonFunctions.latestStories("178#698", 4, "0");
