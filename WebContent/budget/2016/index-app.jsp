...
<cache:cache key="<%=SITE_BASEPATH+"budget/2016/index-app.jsp"%>" scope="application" time="601" >
...
<div id="budget-conetent">
  ...
  <div class="">
    ...
    topStoryList = (ArrayList)getLatestStories("192#758", 4, "0");
    ...
    if (topStoryList != null && topStoryList.size() > 0) {
        for (int ctr = 0; ctr < topStoryList.size(); ctr++) {
            ...
            if (ctr == 0) {%>
            <div class="whitebox">
        <div class="heading"><a class="subheadings" href="<%=SITE_BASEPATH+CommonFunctions.categoryURL(cDTO.getCurrentCategorySefTitle(),1,cDTO.getCurrentCategoryId())%>"><h2>News</h2><span class="moretxt">MORE</span></a></div>
        <div class="content">
      ...
      <li><a href="<%=SITE_BASEPATH+CommonFunctions.storyURL(cDTO.getSefTitle(),1, cDTO.getId())%>?nav=1"><%=cDTO.getTitle()%></a></li>
  <%}}}
  }
  ...
  <!-- Budget EXPECTATION Category -->  
       ...
       <div class="whitebox">
        ...
        <jsp:param name="categoryId" value="192#764" /> 
        <jsp:param name="contentCount" value="3" /> 
        <jsp:param name="storyIdToAvoid" value="0" /> 
        </jsp:include>
      </div>
       ...
       <div class="whitebox">
        ...
        <jsp:param name="categoryId" value="192#763" /> 
        <jsp:param name="contentCount" value="3" /> 
        <jsp:param name="storyIdToAvoid" value="0" /> 
        </jsp:include>
      </div>
