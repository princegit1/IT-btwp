...
%>
<cache:cache key="http://m.businesstoday.in/budget/2016/budget-expectations.jsp?categoryId=<%=categoryId %>&contentCount=<%=contentCount %>" scope="application" time="5" refresh="t" > 
		...
		if (ctr == 0) {
			if(pcatlength==1)
		     ...
		     %>
              ...
              <div class="heading"><a class="subheadings" href="<%=SITE_BASEPATH+CommonFunctions.categoryURL(cDTO.getCurrentCategorySefTitle(),1,cDTO.getCurrentCategoryId())%>" target="_blank"><h2>EXPECTATIONS</h2><span class="moretxt">MORE</span></a></div>
