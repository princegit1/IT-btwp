...
%>
<cache:cache key="http://m.businesstoday.in/budget/2016/budget-quotehanger.jsp?categoryId=<%=categoryId %>&contentCount=<%=contentCount %>" scope="application" time="5" refresh="t" > 
...
%>
   <div class="heading"><a class="subheadings" href="#"><h2>CEO EXPECTATIONS</h2><span class="moretxt">MORE</span></a></div>
	...
	for (int ctr = 0; ctr < lsAL.size(); ctr++) {
		...
		if (ctr == 0) {
			if(pcatlength==1)
		     ...
		     %>
              ...
              <div class="heading"><a class="subheadings" href="<%=SITE_BASEPATH+CommonFunctions.categoryURL(cDTO.getCurrentCategorySefTitle(),1,cDTO.getCurrentCategoryId())%>" target="_blank"><h2>CEO EXPECTATIONS</h2><span class="moretxt">MORE</span></a></div>
        ...
        <div class="content">
           ...
           <%}%>
               ...
               <div class="list-img"><a href="/<%=CommonFunctions.storyURL(cDTO.getSefTitle(),1,cDTO.getId())%>?nav=1"><img src="<%=imagePath%>"></a></div>
               <div class="list-content"><a href="/<%=CommonFunctions.storyURL(cDTO.getSefTitle(),1,cDTO.getId())%>?nav=1"><%=cDTO.getTitle()%></a></div>
               </div> 
             <%}}
			 }
