	...
	for (int ctr = 0; ctr < lsAL.size(); ctr++) {
		...
		if (ctr == 0) {
			if(pcatlength==1)
             ...
             <div class="heading"><a class="subheadings" href="<%=SITE_BASEPATH+CommonFunctions.categoryURL(cDTO.getCurrentCategorySefTitle(),1,cDTO.getCurrentCategoryId())%>" target="_blank"><h2>NEWS</h2><span class="moretxt">MORE</span></a></div>
