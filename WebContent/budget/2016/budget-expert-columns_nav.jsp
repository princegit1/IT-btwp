...
%>
<cache:cache key="<%=SITE_BASEPATH + "budget/2016/budget-expert-columns.jsp?categoryId="+categoryId +"&contentCount="+contentCount %>" scope="application" time="5" refresh="t" > 
...
%>
            <div class="heading"><a class="subheadings" href="#"><h2>EXPERT COLUMNS</h2><span class="moretxt">MORE</span></a></div>
		...
		if (ctr == 0) {
			...
			if(ctr==0)
		     ...
		     %>
              ...
              <div class="heading"><a class="subheadings" href="<%=SITE_BASEPATH+CommonFunctions.categoryURL(cDTO.getCurrentCategorySefTitle(),1,cDTO.getCurrentCategoryId())%>" target="_blank"><h2>EXPERT COLUMNS</h2><span class="moretxt">MORE</span></a></div>
