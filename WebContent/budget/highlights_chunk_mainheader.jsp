...
//if(hp==0)
	//out.println("<tr><td class='subheading' style='padding-left:0px;background:#2E3094 !important'><a href=\""+SITE_URL+"budget/index.jsp\">Highlights</a></td></tr>");

String contentId="207884";
...
%> 
				<tr><td bgcolor="#FFFFFF" style="border-bottom:1px solid #DBDBDB;"><img src="http://m.indiatoday.in/itwapsite/images/blue_squire_bullet.jpg" align="left" width="3" height="3" style="margin:7px 5px 0 1px;"><font style="color:#000;font-size:14px;text-decoration:none; font-family:Arial, Helvetica, sans-serif" ><%=completeNews%></font></td></tr>
<%			}
		}
	}
}
