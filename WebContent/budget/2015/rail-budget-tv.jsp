...
<cache:cache key="<%=SITE_BASEPATH+"budget/2015/index.jsp"%>" scope="application" time="600" >
...
<div class="budget-heading red"><strong>RAILWAY</strong> BUDGET</div>
  <!-- EXPECTATIONS box -->
  <div class="whitebox">
        <%
    ...
    if (contentAL22 != null && contentAL22.size() > 0) {
        ...
        <div class="content">
             ...
             <div class="storyimg"><a href="<%=SITE_BASEPATH+CommonFunctions.storyURL(cDTO.getSefTitle(),1, cDTO.getId())%>"><img src="<%=STORY_IMAGE_BASEPATH+cDTO.getImage().trim()%>" /></a></div>
              <div class="heiglight-section clearfix"><iframe width="290" height="400" frameborder="0" align="left" style="margin-left:10px; margin-top:12px;" scrolling="no" marginwidth="0" src="http://bttemp.intoday.in/highlights/chunk_unionbudget_highlights2015.jsp?id=207984&amp;chunkHeight=439"></iframe></div>
             <ul>
  ...
  <%}}}%>
             ...
             <div class="higlightcta"><a href="#">HIGHLIGHTS</a></div>
