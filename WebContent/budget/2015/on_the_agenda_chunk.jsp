...
%>
            <div class="heading"><a class="subheadings" href="#"><h2>ON THE AGENDA</h2><span class="moretxt">MORE</span></a></div>
		...
		if (ctr == 0) {
			...
			if(ctr==0)
		     ...
		     %>
              ...
              <div class="heading"><a class="subheadings" href="<%=SITE_BASEPATH+CommonFunctions.categoryURL(cDTO.getCurrentCategorySefTitle(),1,cDTO.getCurrentCategoryId())%>"><h2>ON THE AGENDA</h2><span class="moretxt">MORE</span></a></div>
