...
<cache:cache key="<%=SITE_BASEPATH+"budget/2015/index.jsp"%>" scope="application" time="300" >
...
<link rel="canonical" href="http://businesstoday.intoday.in/budget/2015/" />
...
<%-- <%@ include file="rail_budget_card_2.jsp" %>--%> 
  ...
  <div class="">
    ...
    topStoryList = (ArrayList)getLatestStories("178#714", 4, "0");
    ...
    if (topStoryList != null && topStoryList.size() > 0) {
        for (int ctr = 0; ctr < topStoryList.size(); ctr++) {
            ...
            if (ctr == 0) {%>
            <div class="whitebox">
        <div class="heading"><a class="subheadings" href="<%=SITE_BASEPATH+CommonFunctions.categoryURL(cDTO.getCurrentCategorySefTitle(),1,cDTO.getCurrentCategoryId())%>"><h2>HITS AND MISSES</h2><span class="moretxt">MORE</span></a></div>
        <div class="content">
  ...
  %>
                ...
                <div class="higlightcta"><a target="_blank" href="http://m.businesstoday.in/story/union-budget-2015-16/1/216112.html">HIGHLIGHTS</a></div>
 ...
 <%-- <div class="whitebox">
       ...
       <div class="whitebox">
          <jsp:include page="announcements_stories_chunk.jsp" flush="true">
        <jsp:param name="categoryId" value="178#711" /> 
        <jsp:param name="contentCount" value="3" /> 
        <jsp:param name="storyIdToAvoid" value="0" /> 
        </jsp:include>
      </div>
        ...
        <div class="whitebox">
         <jsp:include page="reactions_stories_chunk.jsp" flush="true">
        <jsp:param name="categoryId" value="178#712" /> 
        <jsp:param name="contentCount" value="3" /> 
        <jsp:param name="storyIdToAvoid" value="0" /> 
        </jsp:include>
      </div>
       ...
       <div class="whitebox">
         <jsp:include page="india_inc_stories_chunk_old.jsp" flush="true">
        <jsp:param name="categoryId" value="178#716" /> 
        <jsp:param name="contentCount" value="3" /> 
        <jsp:param name="storyIdToAvoid" value="0" /> 
        </jsp:include>
      </div>
       ...
       <div class="whitebox">
         <jsp:include page="your_finance_stories_chunk.jsp" flush="true">
        <jsp:param name="categoryId" value="178#713" /> 
        <jsp:param name="contentCount" value="3" /> 
        <jsp:param name="storyIdToAvoid" value="0" /> 
        </jsp:include>
      </div>
       ...
       <div class="whitebox">
         <jsp:include page="stock_impact_chunk.jsp" flush="true">
        <jsp:param name="categoryId" value="178#715" /> 
        <jsp:param name="contentCount" value="3" /> 
        <jsp:param name="storyIdToAvoid" value="0" /> 
        </jsp:include>
      </div>
       ...
       <div class="whitebox">
        ...
        <jsp:param name="storyIdToAvoid" value="0" /> 
          ...
          <%@ include file="economic_budget_card_1.jsp" %>
      <%@ include file="rail_budget_card_2.jsp" %>   
