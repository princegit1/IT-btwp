...
<div class="heading"><a href="<%=SITE_BASEPATH+"category/decoding-budget-2014/1/636.html"%>" class="subheadings"><h2>BUDGET DECODED</h2></a></div>
	  <%
 ...
 <div class="heading"><a href="<%=SITE_BASEPATH+"index.jsp"%>" class="subheadings"><h2 style="text-transform:uppercase">Highlights</h2></a></div>
    <jsp:include page="highlights_chunk_mainheader.jsp" flush="true" >
...
<div class="tab">
    ...
    <div class="belt-outer">
      ...
      <ul class="belt-tab">
         	...
         	<li><div class="box-tab"><a href="#ceowishlist">REACTIONS</a></div></li>
           	<li><div class="box-tab"><a href="#ceospeak">CEO SPEAK</a></div></li>
      </ul>
   ...
   <div class="tab-budget" id="price-hike" style="display:none;">   
	...
	<div class="tab-budget" id="ceospeak" style="display:none;">   
        <jsp:include page="../latest_stories_chunk_budget.jsp" flush="true" >
...
%>
 ...
 <div class="heading"><a href="../videolist.jsp" class="subheadings"><h2>VIDEO</h2></a></div>
 <!--<div class="container">
