...
<title>Business Today Budget 2013</title>
...
<tr><td class="breadcrumb" colspan="2"><a href="<%=SITE_URL%>">HOME</a> &raquo; <a href="index.jsp">Budget 2013-14</a> &raquo; <%if(contentId.equals("192721")){	 out.print("Railway Budget");	} else if (contentId.equals("177867")){	out.print("Union Budget");	} %></td></tr>   
...
<%	}}} }catch(Exception e){}%>
<tr><td height="8"></td></tr>
<tr><td class="more" colspan="2"><%if(contentId.equals("177867")){ %>Highlights from &raquo; <a href="story_highlights.jsp?id=192721">Railway Budget</a><% }else if (contentId.equals("192721")){%>Highlights from &raquo; <a href="story_highlights.jsp?id=177867">Union Budget</a><%} %>
</td></tr>
</table>
