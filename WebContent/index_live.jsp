...
<cache:cache key="<%=SITE_BASEPATH+"index_live.jsp"%>" scope="application" time="300" refresh="t" >
...
<%--    <%@include file="/budget/2015/rail_budget_card_live.jsp"%> --%>
<%--  <%@ include file="/budget/2015/rail_budget_card_2.jsp" %>  --%>
    ...
    if (topStoryList != null && topStoryList.size() > 0) {
        ...
        <div class="content">
             ...
             <iframe width="300" height="170" frameborder="0" id="livetv_video1" scrolling="no" allowfullscreen="" src="http://new.livestream.com/accounts/11965022/events/3778278/player?width=560&amp;height=315&amp;autoPlay=true&amp;mute=false"></iframe>
                 ...
                 <h3>Highlights</h3>
                 <iframe width="290" height="400" frameborder="0" align="left" style="margin-left:10px; margin-top:12px;" scrolling="no" marginwidth="0" src="http://businesstoday.intoday.in/highlights/chunk_unionbudget_highlights2015.jsp?id=216112&amp;chunkHeight=439"></iframe>
                 
                 <h4><a target="_blank" href="http://businesstoday.intoday.in/highlights/chunk_unionbudget_highlights2015.jsp?id=216112&amp;chunkHeight=439">More</a></h4>
  ...
  <div class="whitebox">
         <jsp:include page="/budget/2015/on_the_agenda_chunk.jsp" flush="true">
  ...
  <div class="whitebox">
          <jsp:include page="/budget/2015/expert_speak_stories_chunk.jsp" flush="true">
        ...
        <!-- GALLERY Section -->
  <div class="whitebox">
        <jsp:include page="/budget/2015/gallery_chunk.jsp" flush="true">
  ...
  <!-- Other News Section -->
  <div class="whitebox">
         <jsp:include page="/budget/2015/other_news_stories_chunk.jsp" flush="true">
      ...
      <!-- videos Section -->
       ...
       <div class="whitebox">
        <jsp:include page="/budget/2015/video_chunk.jsp" flush="true">
      ...
      <%--     <%@ include file="/budget/2015/rail_budget_card_1.jsp" %>  --%>
         <%@ include file="/budget/2015/economic_budget_card_1.jsp" %>
