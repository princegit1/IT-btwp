...
<cache:cache key="<%=SITE_URL+"home_video_chunk.jsp"%>" scope="application " time="300" refresh="t" >
...
<%
int videoCountDisplay = 5;
//int[] stArray={42, 43, 39, 44,705};
//int[] stArray={640,634,511,549,617,623};
...
//{
	...
	ArrayList videoListData = (ArrayList) ContentChunkHelper.alllatestVideo(videoCountDisplay, "0");
...
%>
			...
			<% }%>
			<!--<div><a href="<%//=catDetail.getCategoryURL()%>"><b><%//=catDetail.getCategoryTitle()%></b></a></div> -->
			<a  href="/<%=catDetail.getContentURL()%>"><span class="story-title"><%=catDetail.getTitle()%></span></a></div></td></tr>
<%}} 

out.print("<tr><td class='more' bgcolor='#ffffff' style='PADDING-LEFT: 2px; BORDER-BOTTOM: #c7c7c7 1px solid'><a href=\"/videosection.jsp\">more &raquo;</a></td></tr>");

/*
if(i == stArray.length-1 ){
	out.print("<tr><td class='more' bgcolor='#ffffff' style='PADDING-LEFT: 2px; BORDER-BOTTOM: #c7c7c7 1px solid'><a href=\"/videosection.jsp\">more »</a></td></tr>");
}}
*/
