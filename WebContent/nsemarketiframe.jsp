        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tbody>
                <tr>
                    <td bgcolor="#ffffff">
                                          <div align="center">	
    <iframe src="http://businesstoday.acemf.co.in/Market/indicesNSE.aspx?IndicesDrp=NIFTY&Period=Daily" frameborder="0"  height="1000" width="380" scrolling="auto"></iframe>
    </div>
                    </td>
                </tr>
